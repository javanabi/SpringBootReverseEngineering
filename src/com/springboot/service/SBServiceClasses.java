...
public class SBServiceClasses extends AbstractDataAccessObject{
	...
	public void createServiceMethods(String className,Connection con,String title,String pack,String projectName) throws SQLException{
		try {
			...
			PrintWriter writer = new PrintWriter(packageNameString + "\\"
					+ CapitalCase.toCapitalCase(className) + "Service.java");
			...
			writer.println("public class "
					+ CapitalCase.toCapitalCase(className) + "Service{\n\n\n");
